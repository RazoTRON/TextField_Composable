...
val semIsErrorKey = SemanticsPropertyKey<Boolean>("IsError")
var SemanticsPropertyReceiver.semIsError by semIsErrorKey

val semPlaceholderKey = SemanticsPropertyKey<@Composable (() -> Unit)?>("Placeholder")
var SemanticsPropertyReceiver.semPlaceholder by semPlaceholderKey